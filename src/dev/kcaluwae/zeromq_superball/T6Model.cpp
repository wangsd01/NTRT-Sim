...
void T6Model::addNodes(tgStructure& s, Config c)
{
...
*/
  // # left vertical rod
  // left_vert_bottom: [4.886,  1.5, 0] #1
  // left_vert_top:    [4.886, 20.5, 0] #2
  // # right vertical rod
  // right_vert_bottom: [-4.887,  1.5, 0] #3
  // right_vert_top:    [-4.887, 20.5, 0] #4

  // # bottom horizontal rod
  // bottom_horiz_prox: [0, 5.316, -9.5] #5
  // bottom_horiz_dist: [0, 5.316,  9.5] #6
  // # top horizontal rod
  // top_horiz_prox: [0, 14.94, -9.5] #7
  // top_horiz_dist: [0, 14.94,  9.5] #8

  // # proxal horizontal rod
  // prox_horiz_left:  [ 9.5, 10.09, -4.821] #9
  // prox_horiz_right: [-9.5, 10.09, -4.821] #10
  // # distal horizontal rod
  // dist_horiz_left:  [ 9.5, 10.09, 4.822] #11
  // dist_horiz_right: [-9.5, 10.09, 4.822] #12

    s.addNode( 4.886,  1.5, 0);    // 1
    s.addNode( 4.886, 20.5, 0);    // 2
    s.addNode( -4.887,  1.5, 0);    // 3
    s.addNode( -4.887, 20.5, 0);    // 4
    s.addNode( 0, 5.316, -9.5);      // 5
    s.addNode(0, 5.316, 9.5);      // 6
    s.addNode(0, 14.94, -9.5);    // 7
    s.addNode(0, 14.94, 9.5);    // 8
    s.addNode( 9.5, 10.09, -4.821);    // 9
    s.addNode( -9.5, 10.09, -4.821);    // 10
    s.addNode(  9.5, 10.09, 4.822);      // 11
    s.addNode( -9.5, 10.09, 4.822);          // 12

    //ZL Replacing for V2 superball
...
void T6Model::addActuators(tgStructure& s)
{
    ...
    */
    ...
    s.addPair(0,    5,  "actuated");
    s.addPair(1,    6,  "actuated");
    s.addPair(1,    7, "actuated");
    s.addPair(2,   4,  "actuated");
    s.addPair(2,    5,  "actuated");
    s.addPair(3,    6, "actuated");
    s.addPair(3,   7,  "actuated");
    s.addPair(4,    8,  "actuated");
    s.addPair(4,    9,  "actuated");
    s.addPair(5,    10,  "actuated");
    s.addPair(5,    11,  "actuated");
    s.addPair(6,    8,  "actuated");
    s.addPair(6,    9,  "actuated");
    s.addPair(7,   10,  "actuated");
    s.addPair(7,   11,  "actuated");
    s.addPair(8,    0, "actuated");
    s.addPair(8,    1,  "actuated");
    s.addPair(9,    2,  "actuated");
    s.addPair(9,    3,  "actuated");
    s.addPair(10,    0,  "actuated");
    s.addPair(10,    1, "actuated");
    s.addPair(11,    2,  "actuated");
    ...
    // s.addPair(7,    11, "actuated");
    // s.addPair(11,   3,  "actuated");
    // s.addPair(3,    0,  "actuated");

    // //Triangle 1
    // s.addPair(1,    10, "actuated");
    // s.addPair(10,   9,  "actuated");
    // s.addPair(9,    1,  "actuated");
    ...
    // //actuated cables (triangle 2 - large circle)
    // s.addPair(2,    4,  "actuated");
    // s.addPair(2,    0,  "actuated");
...
void T6Model::setup(tgWorld& world, Config c)
{
    ...
    //ZL 4/21/17: This changes the actuator to a basic one. this is no longer kinematic.
    spec.addBuilder("actuated", new tgBasicActuatorInfo(motorConfig));



    // spec.addBuilder("actuated", new tgKinematicContactCableInfo(motorConfig));
