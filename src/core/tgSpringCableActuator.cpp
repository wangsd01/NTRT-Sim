...
{
    m_restLength = m_springCable->getRestLength();
    return m_restLength;
}
void tgSpringCableActuator::setRestLength(double newRest) 
{
    // m_restLength = newRest;
    m_springCable->setRestLength(newRest);
    m_restLength = m_springCable->getRestLength();
}
...
const double tgSpringCableActuator::getPreviousLength() const
{
    return m_springCable->getPreviousLength();
}

void tgSpringCableActuator::setPreviousLength( const double newPreviousLength)
{
    m_springCable->setPreviousLength(newPreviousLength);
}
