...
public: 
    ...
    /**
     * Sets the rest length of the spring-cable
     */
    virtual void setRestLength(double newRest);
    ...
    const double getPreviousLength() const;

    void setPreviousLength( const double newPreviousLength);
