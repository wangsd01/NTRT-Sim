...
public:
   ...
   friend class tgBulletContactSpringCable;
     ...
     * when the body was first contacted.
     */
    virtual void setContactNormal(btVector3 c)
    {
    	contactNormal = c;
    }
    ...
    void setManifold(btPersistentManifold* m);
    ...
    btVector3 getRelativeOriginalPosition()
    {
    	return attachedRelativeOriginalPosition;
    }
    void setRelativeOriginalPosition(btVector3 vec)
    {
    	attachedRelativeOriginalPosition = vec;
    }
