...
public:
    ...
    */
     ...
     * @return true if the anchor has been deleted
     */
    tgBulletSpringCableAnchor* addAnchor(btRigidBody* rb, btVector3 pos, btVector3 m_touchingNormal, bool permanent, bool sliding, btPersistentManifold* new_manifold, int index_to_insert);
    ...
    void stateUpdateCollisionObject();
